...
class Product(models.Model):
    ...
    Attributes:
        ...
        category (str): The category of the product (Software, Ebook, etc.).
        vendor (Vendor): The vendor who sells this product.
        created_at (str): Timestamp when the product was created.
        ...
        file (models.FileField): The file associated with the product (e.g., digital download).
        image (models.ImageField): An optional image for product preview.
    """
    ...
    file: models.FileField = models.FileField(
        upload_to="products/%Y/%m/%d/", null=True, blank=True, max_length=512  # Increase max_length
    )
    image: models.ImageField = models.ImageField(
        upload_to="product_images/", null=True, blank=True, max_length=512  # Increase max_length
    )
